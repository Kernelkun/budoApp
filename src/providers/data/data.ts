...
export class DataProvider {
  techniques = {
    "yellow": [
      ...
      { "name": "Kami", "description": "Significa: Control de la parte superior y por cuatro puntos. Se ejerce desde la cabeza de Uke y agarrando el cinturón de este con las dos manos bajando el centro de gravedad para así tener controlada toda la parte del tren superior.", "kanji": "上四方固", "icon": "remove", "belt": "yellow" },
    ...
    "orange": [
      ...
      { "name": "O Goshi", "description": "Significa: Control de la parte superior y por cuatro puntos. Se ejerce desde la cabeza de Uke y agarrando el cinturón de este con las dos manos bajando el centro de gravedad para así tener controlada toda la parte del tren superior.", "kanji": "上四方固", "icon": "remove", "belt": "orange" },
